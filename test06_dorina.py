...
class TestGame:
    ...
    def move_position(self):
        ...
        elif self.last_event == pygame.K_DOWN:
            self.box_position_y += 20
        elif self.last_event == pygame.K_UP:
            self.box_position_y -= 20
        elif self.last_event == pygame.K_RIGHT:
            self.box_position_x += 20
        elif self.last_event == pygame.K_LEFT:
            self.box_position_x -= 20
